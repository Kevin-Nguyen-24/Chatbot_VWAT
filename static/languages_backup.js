...
const translations = {
    vi: {
        // Welcome messages
        welcomeMessage: 'Xin chào, chào mừng đến với Dịch vụ Gia đình VWAT! Tôi là trợ lý ảo của bạn - ở đây để giúp bạn tiếp cận các dịch vụ định cư và việc làm miễn phí của chúng tôi, cũng như các chương trình dành cho người mới đến, thanh thiếu niên và người cao tuổi. Hôm nay tôi có thể giúp gì cho bạn?',
        helpQuestion: 'Tôi có thể giúp gì cho bạn?',
        
        // Main menu options
        settlementHelp: 'Mới đến Canada / Hỗ trợ định cư',
        jobTraining: 'Việc làm hoặc đào tạo',
        englishClass: 'Lớp tiếng Anh',
        formsTax: 'Biểu mẫu / thuế / phúc lợi',
        seniorServices: 'Dịch vụ người cao tuổi',
        youthPrograms: 'Chương trình thanh thiếu niên',
        volunteerEvents: 'Tình nguyện / sự kiện / hợp tác',
        otherNotSure: 'Khác / Không chắc',
        ...
        // Settlement Help Branch
        settlementHelpIntro: 'Chào mừng đến Canada! Chúng tôi hỗ trợ người mới đến với nhà ở, chăm sóc sức khỏe, trường học và nhiều hơn nữa. Hôm nay bạn cần giúp gì?',
        findDoctor: 'Tìm bác sĩ gia đình hoặc xin thẻ sức khỏe (thẻ OHIP)',
        enrollSchool: 'Đăng ký con em vào trường',
        newcomerBenefits: 'Nộp đơn xin phúc lợi người mới đến (ví dụ: Phúc lợi Trẻ em, SIN, v.v.)',
        immigrationDocs: 'Hiểu về tài liệu nhập cư hoặc PR',
        other: 'Khác',
        
        findDoctorResponse: 'VWAT có thể giúp bạn tìm bác sĩ gia đình hoặc thẻ sức khỏe. Bạn có thể gọi cho chúng tôi theo số 647-343-8928, nối máy 116, điền vào mẫu liên hệ của chúng tôi hoặc đặt lịch hẹn tại đây. Nhân viên định cư sẽ liên hệ lại để hỗ trợ bạn. Chúng tôi sẽ phản hồi trong vòng 1 đến 2 ngày làm việc.',
        enrollSchoolResponse: 'VWAT có thể giúp bạn đăng ký con em vào trường. Bạn có thể gọi cho chúng tôi theo số 647-343-8928, nối máy 116, điền vào mẫu liên hệ của chúng tôi hoặc đặt lịch hẹn tại đây. Nhân viên định cư sẽ liên hệ lại để hỗ trợ bạn. Chúng tôi sẽ phản hồi trong vòng 1 đến 2 ngày làm việc.',
        newcomerBenefitsResponse: 'VWAT có thể giúp bạn nộp đơn xin phúc lợi người mới đến như Phúc lợi Trẻ em, SIN hoặc OHIP. Bạn có thể gọi cho chúng tôi theo số 647-343-8928, nối máy 116, điền vào mẫu liên hệ của chúng tôi hoặc đặt lịch hẹn tại đây. Nhân viên định cư sẽ liên hệ lại để hỗ trợ bạn. Chúng tôi sẽ phản hồi trong vòng 1 đến 2 ngày làm việc.',
        immigrationDocsResponse: 'VWAT có thể giúp bạn hiểu về tài liệu nhập cư hoặc PR của bạn. Bạn có thể gọi cho chúng tôi theo số 647-343-8928, nối máy 116, điền vào mẫu liên hệ của chúng tôi hoặc đặt lịch hẹn tại đây. Nhân viên định cư sẽ liên hệ lại để hỗ trợ bạn. Chúng tôi sẽ phản hồi trong vòng 1 đến 2 ngày làm việc.',
        
        otherPrompt: 'Bạn có thể cho chúng tôi biết sơ lược bạn đang tìm kiếm gì không?',
        settlementFallback: 'Cảm ơn bạn đã chia sẻ. Điều này có thể được xử lý tốt nhất bởi một trong số những nhân viên định cư của chúng tôi. Bạn có thể gọi cho chúng tôi theo số 647-343-8928, nối máy 116, điền vào mẫu liên hệ của chúng tôi hoặc đặt lịch hẹn tại đây. Nhân viên định cư sẽ liên hệ lại để hỗ trợ bạn. Chúng tôi sẽ phản hồi trong vòng 1 đến 2 ngày làm việc.',
    ...
    en: {
        // Welcome messages
        welcomeMessage: 'Hello, welcome to VWAT Family Services. I\'m your virtual assistant - here to help you access our free settlement and employment services, as well as programs for newcomers, youth, and seniors. How can I help you today?',
        helpQuestion: 'What can I help you with?',
        
        // Main menu options
        settlementHelp: 'New to Canada / Settlement help',
        jobTraining: 'Job or training',
        englishClass: 'English class',
        formsTax: 'Forms / tax / benefits help',
        seniorServices: 'Senior services',
        youthPrograms: 'Youth programs',
        volunteerEvents: 'Volunteer / events / partnerships',
